...
\vspace{2mm}
\textit{Hautwiderstand und Hauttemperatur}  \newline
...
\begin{tabular}{c c c }
	\textbf{2 . Aufgabe} &  Zeit: 10 min & Gruppenarbeit (4 Personen)\\
\end{tabular}

\vspace{1mm}


Im Workshop wollten wir gemeinsam mit allen Teilnehmern so viele Methoden wie möglich zum Emotion Tracking finden. Dazu wurden die in Kapitel \ref{MethodenEmotionTracking} genannten Methoden den Teilnehmern erstmal vorenthalten. Die Teilnehmer sollten im Internet über Methoden zum Tracken der Emotionen einer Person recherchieren. Dabei sollten die Methode in Ihrer Gruppe diskutiert und die Ergebnisse in einem Google Formular notiert werden.

\vspace{2mm}
\textit{Ergebnisse der zweiten Aufgabe} \newline
